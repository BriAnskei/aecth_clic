...
namespace aesth_clic.Views.Roles.Admin.Modals
{
    public sealed partial class ReactivateUser : ContentDialog
    {
        ...
        /// <summary>True once the admin pressed Yes, Reactivate.</summary>
        public bool Confirmed { get; private set; }

        /// <summary>Populated if the controller call throws.</summary>
        public Exception? SaveError { get; private set; }

        public ReactivateUser(StaffUserItem user, UserController userController)
        {
