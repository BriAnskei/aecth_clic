...
{
    public sealed partial class ReactivateUser : ContentDialog
    {
        ...
        public ReactivateUser(StaffUserItem user)
        {
            ...
            PrimaryButtonText = "Yes, Reactivate";
        ...
        private void BuildContent()
        {
            ...
            var icon = new Border { Width = 72, Height = 72, CornerRadius = new CornerRadius(36), Background = new SolidColorBrush(Color.FromArgb(0x1A, 0x0E, 0xA4, 0x7A)), HorizontalAlignment = HorizontalAlignment.Center };
            icon.Child = new FontIcon { Glyph = "\uE72C", FontSize = 32, Foreground = new SolidColorBrush(Color.FromArgb(0xFF, 0x0E, 0xA4, 0x7A)), HorizontalAlignment = HorizontalAlignment.Center, VerticalAlignment = VerticalAlignment.Center };
            ...
            msgStack.Children.Add(new TextBlock { Text = "Are you sure you want to reactivate this user account?", FontSize = 13, TextWrapping = TextWrapping.Wrap, Foreground = new SolidColorBrush(Microsoft.UI.Colors.Black) });
            msgStack.Children.Add(new TextBlock { Text = "The user will regain access to the system immediately using their existing credentials.", FontSize = 12, TextWrapping = TextWrapping.Wrap, Foreground = new SolidColorBrush(Color.FromArgb(0xFF, 0x9B, 0x80, 0xC4)) });

            var infoBorder = new Border { Background = new SolidColorBrush(Color.FromArgb(0x1A, 0x0E, 0xA4, 0x7A)), BorderBrush = new SolidColorBrush(Color.FromArgb(0x40, 0x0E, 0xA4, 0x7A)), BorderThickness = new Thickness(1), CornerRadius = new CornerRadius(6), Padding = new Thickness(12, 10, 12, 10) };
            var infoInner = new StackPanel { Orientation = Orientation.Horizontal, Spacing = 10 };
            infoInner.Children.Add(new FontIcon { Glyph = "\uE783", FontSize = 14, Foreground = new SolidColorBrush(Color.FromArgb(0xFF, 0x0E, 0xA4, 0x7A)), VerticalAlignment = VerticalAlignment.Top });
            infoInner.Children.Add(new TextBlock { Text = "All previous data, settings, and assigned modules will be restored for this user.", FontSize = 12, TextWrapping = TextWrapping.Wrap, Foreground = new SolidColorBrush(Color.FromArgb(0xFF, 0x0E, 0xA4, 0x7A)) });
            ...
            overlayStack.Children.Add(new TextBlock { Text = "Activating…", VerticalAlignment = VerticalAlignment.Center, FontSize = 13, Foreground = new SolidColorBrush(Color.FromArgb(0xFF, 0x9B, 0x80, 0xC4)) });
